...
export default function Home(){
  ...
  return <>
    <section className="hero">
      ...
      <div className="container hero__inner">
        <div className="hero__copy">
          ...
          <h1>Built on <em>connection.</em><br/>Powered by <em>every journey.</em></h1>
    ...
    <section className="find-section"><div className="container find-layout">
      <div className="find-copy"><p className="eyebrow">THE DIRECTORY</p><h2>Find an<br/><em>alumnus.</em></h2><p>Search the NITER EEE community by name, batch, district, field, or organization. Every profile is a point of connection.</p><div className="find-copy__detail"><GraduationCap size={23}/><span>Designed as a living directory that can grow with every graduate.</span></div></div>
